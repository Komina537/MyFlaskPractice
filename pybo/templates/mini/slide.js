...
// requestAnimationFrame() 메서드로 스크롤 이벤트 최적화 하기
...
const animationMove = function(selector){
  ...
  // 이미지 자동 변환 소스 코드 <실행 x , absolute 쓰면 코드가 꼬임 >
var showImg, nextImg;
...
function fadeInOut(){
    ...
    nextImg.css("opacity","0").animate({opacity:2},4000, 
    function() {     
        $(".fadeShow").append( showImg );     //콜백
